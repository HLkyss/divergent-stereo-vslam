...
///////////////////////////////////////////////////
        ...
        vdescs_l = describeBRIEF(img_left, vpts);
        vdescs_r = describeBRIEF(img_right, vpts);
        ...
        vnewpts_l = detectSingleScale(img_left, nmaxdist, vpts, roi_rect_);
        vnewpts_r = detectSingleScale(img_right, nmaxdist, vpts, roi_rect_);
        //可视化出特征点
